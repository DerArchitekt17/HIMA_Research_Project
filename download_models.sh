...
cp -r single_agent/${OUTPUT_BERTMODEL_DIR} baseline/

# Download base small LLM for comparison
hf download "${MODEL_NAME_SMALL}" --local-dir "single_agent_small/${OUTPUT_DIR}"
cp -r single_agent_small/${OUTPUT_DIR} multi_agents_small/
cp -r single_agent_small/${OUTPUT_DIR} swarm_agents_small/
