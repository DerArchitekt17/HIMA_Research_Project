...
cp -r single_agent/${OUTPUT_DIR} multi_agent/${OUTPUT_DIR}
...
cp -r single_agent/${BERTSCORE_MODEL} multi_agent/${BERTSCORE_MODEL}
#cp -r single_agent/${BERTSCORE_MODEL} swarm_agents/${BERTSCORE_MODEL}
